...
<div class="modal fade modal-lg" id="UpdatePrintingModel" tabindex="-1" aria-labelledby="UpdatePrintingModelLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="UpdatePrintingModelLabel">Update Production</h5>
