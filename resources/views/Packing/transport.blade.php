        ...
        <div class="mb-3 text-left">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb fs-6">
                    ...
                    <li class="breadcrumb-item fs-6"><a href="#">{{$flag}}</a></li>
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select type="text" id="transPortType" name="transPortType" class="form-select" required>
                                    <option value="">Select</option>
                                    <option value="For Delivery" {{$flag=="For Delivery"  ? "selected" : ""}}>For Delivery</option>
                                    <option value="For Godown" {{$flag=="For Godown"  ? "selected" : ""}}>For Godown</option>
                                </select>
...
<script>
    ...
    $(document).ready(function(){
        ...
        const table = $('#transportTable').DataTable({
            ...
            searching:false,
            ajax: {
                url: "{{route('packing.transport.for',':flag')}}".replace(':flag', flag), // The route where you're getting data from                
                beforeSend: function() {
